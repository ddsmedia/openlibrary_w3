//
//  LibrosUITableViewController.swift
//  openlibrary
//
//  Created by Angel Gabriel Ramirez Alva on 03/01/16.
//  Copyright © 2015 DDS.media. All rights reserved.
//

import UIKit

class LibrosUITableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.title = "Lista Libros ISBN"
        
        // preserve selection between presentations
        // self.clearsSelectionOnViewWillAppear = false

        // display an Add button in the navigation bar for this view controller.
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Add (+)", style: .Plain, target: self, action: "searchByISBN")
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        let libroController = segue.destinationViewController as! LibroViewController
    ...
    @IBAction func unwindToVC(segue:UIStoryboardSegue) {
        let libroController = segue.sourceViewController as! LibroViewController
        self.libros.append([libroController.uiLabelTitulo.text!, libroController.isbn])
        self.uiTableLibros.reloadData()
    }
